...
const backofficeClient = {
  async sendReport({ reporterId, reporterUsername, reportedId, reportedUsername, reason, createdAt }) {
    ...
    const response = await fetch(url, {
      ...
      body: JSON.stringify({ reporterId, reporterUsername, reportedId, reportedUsername, reason, createdAt }),
    });
